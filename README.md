...
/portfolio init/status/review/mark/sell/trades/rebalance
                              创建纸面组合、查看持仓、诊断替换候选、每日估值、模拟卖出、交易流水、再平衡
