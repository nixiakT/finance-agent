...
当用户要求“模拟卖出/卖掉/止损/止盈/交易流水/买卖记录”时，使用 finance_sell_paper_holding 或 finance_paper_trades；必须记录数量、价格、理由和实现盈亏。
...
- 模拟投资组合：finance_build_paper_portfolio/finance_rebalance_paper_portfolio/finance_mark_paper_portfolio/finance_show_paper_portfolio/finance_sell_paper_holding/finance_paper_trades/finance_review_paper_portfolio
